...
writetable(dataTableUC, 'UC_DC_STEP_ACTIVO_5000KW_1000V_2.xlsx', 'Sheet', 'UC');
writetable(tablaUC, 'UC_DC_STEP_ACTIVO_5000KW_1000V_3.xlsx', 'Sheet', 'UC_1');
    %write(dataTable, 'VandI_offgrid.csv');
    %creacion de archivo parquet 
parquetwrite('UC_DC_STEP_ACTIVO_5000KW_1000V_4', dataTableUC);
parquetwrite('UC_DC_STEP_ACTIVO_5000KW_1000V_5', tablaUC);
